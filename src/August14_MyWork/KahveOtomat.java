...
public class KahveOtomat {
  ...
  sorusunu sorsun.
    ...
    /*
    4. Şart
  Şeker tercihini yaptıktan sonra sistem kullanıcıya kahvenin "Hangi boyutta olsun? (Ekstra boy - Büyük boy - orta boy - küçük boy olarak giriniz.)
  sorusunu sorsun.
     */
   ...
   Siparişlerimizi verdik. Son hali görmek istiyoruz.
        ...
        Türk Kahvesi ekstra boy hazırdır. Afiyet olsun !!!
     */
    static void sonuc(){
        if (sut.equalsIgnoreCase("evet"))
            sut="sütlü";
